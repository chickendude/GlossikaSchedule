...
public class ScheduleData {
	...
	public static ArrayList<ScheduleType> getScheduleTypes() {
		...
		scheduleTypes.add(new ScheduleType(SCHEDULE_9_RELAXED, SCHEDULE_9_RELAXED_STRINGS, 20, 57000, SCHEDULE_9_RELAXED_SUMMARY, SCHEDULE_9_RELAXED_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_5_RELAXED, SCHEDULE_5_RELAXED_STRINGS, 60, 64000, SCHEDULE_5_RELAXED_SUMMARY, SCHEDULE_5_RELAXED_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_5_INTENSIVE, SCHEDULE_5_INTENSIVE_STRINGS, 90, 94000, SCHEDULE_5_INTENSIVE_SUMMARY, SCHEDULE_5_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_4_INTENSIVE, SCHEDULE_4_INTENSIVE_STRINGS, 70, 57000, SCHEDULE_4_INTENSIVE_SUMMARY, SCHEDULE_4_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_3_INTENSIVE, SCHEDULE_3_INTENSIVE_STRINGS, 60, 43000, SCHEDULE_3_INTENSIVE_SUMMARY, SCHEDULE_3_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_2_INTENSIVE, SCHEDULE_2_INTENSIVE_STRINGS, 60, 31000, SCHEDULE_2_INTENSIVE_SUMMARY, SCHEDULE_2_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_6_WEEK_INTENSIVE, SCHEDULE_6_WEEK_INTENSIVE_STRINGS, 90, 29000, SCHEDULE_6_WEEK_INTENSIVE_SUMMARY, SCHEDULE_6_WEEK_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_4_WEEK_INTENSIVE, SCHEDULE_4_WEEK_INTENSIVE_STRINGS, 90, 18000, SCHEDULE_4_WEEK_INTENSIVE_SUMMARY, SCHEDULE_4_WEEK_INTENSIVE_DESCRIPTION));
		scheduleTypes.add(new ScheduleType(SCHEDULE_3_WEEK_INTENSIVE, SCHEDULE_3_WEEK_INTENSIVE_STRINGS, 125, 18000, SCHEDULE_3_WEEK_INTENSIVE_SUMMARY, SCHEDULE_3_WEEK_INTENSIVE_DESCRIPTION));
